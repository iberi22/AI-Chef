...
main_ingredients:
  ...
  - Vinagre de arroz
  - Salmón fresco de calidad sushi
  - Wasabi fresco
  - Salsa de soja shoyu
sensory:
  flavor:
    - Vinagre de arroz equilibrado
    - Grasa limpia de salmón
    - Umami de wasabi
  texture:
    - Arroz tibio y suelto
    - Pescado suave que se derrite
  aroma:
    - Arroz vinagrado
    - Salmón fresco grado sushi
  presentation: >-
    Bocado individual de arroz moldeado a mano coronado con una lámina de salmón
    fresco brillante.
nutrition:
  calories: 340
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Nigiri Sushi de Salmón tradicional
description: >-
...
* **Sabor:** Vinagre de arroz equilibrado, Grasa limpia de salmón, Umami de wasabi
* **Textura:** Arroz tibio y suelto, Pescado suave que se derrite
* **Aroma:** Arroz vinagrado, Salmón fresco grado sushi
* **Presentación:** Bocado individual de arroz moldeado a mano coronado con una lámina de salmón fresco brillante.
