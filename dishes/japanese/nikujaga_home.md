---
title: Nikujaga (Res con Patatas)
region: Japón Nacional
language: es
license: MIT
source:
  name: Gastronomic Open Standard (GOS) Database
  url: https://park.ajinomoto.co.jp/recipe/card/701046/
...
sensory:
  flavor:
    - Dulce salado reconfortante
    - Umami suave
  texture:
    - Patatas tiernas impregnadas de caldo
    - Carne suave
  aroma:
    - Dashi casero
    - Cebolla caramelizada
  presentation: >-
    Guiso casero cálido servido en tazón hondo con patatas redondeadas y finas
    tiras de res.
nutrition:
  calories: 480
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Nikujaga (Res con Patatas) tradicional
description: >-
...
* **Sabor:** Dulce salado reconfortante, Umami suave
* **Textura:** Patatas tiernas impregnadas de caldo, Carne suave
* **Aroma:** Dashi casero, Cebolla caramelizada
* **Presentación:** Guiso casero cálido servido en tazón hondo con patatas redondeadas y finas tiras de res.
