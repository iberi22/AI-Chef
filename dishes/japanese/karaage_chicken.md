...
source:
  ...
  url: https://park.ajinomoto.co.jp/recipe/card/701831/
...
sensory:
  flavor:
    - Salado jengibre
    - Umami de soja marinada
    - Ajo potente
  texture:
    - Exterior crujiente de almidón
    - Interior de pollo muy jugoso
  aroma:
    - Marinada de soja y jengibre
    - Aceite de sésamo
  presentation: >-
    Bocadillos dorados crujientes servidos con gajos de limón fresco y mayonesa
    Kewpie.
nutrition:
  calories: 520
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Chicken Karaage tradicional
description: >-
  El Karaage es el pollo frito al estilo japonés: trozos de muslo marinados en
...
* **Sabor:** Salado jengibre, Umami de soja marinada, Ajo potente
* **Textura:** Exterior crujiente de almidón, Interior de pollo muy jugoso
* **Aroma:** Marinada de soja y jengibre, Aceite de sésamo
* **Presentación:** Bocadillos dorados crujientes servidos con gajos de limón fresco y mayonesa Kewpie.
