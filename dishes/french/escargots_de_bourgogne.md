...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Escargots de Bourgogne
  presentation: Escargots de Bourgogne presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Escargots de Bourgogne tradicional
description: >-
  Escargots de Bourgogne es uno de los platos más emblemáticos de la gastronomía
...
* **Aroma:** Aroma característico de Escargots de Bourgogne
* **Presentación:** Escargots de Bourgogne presentado de forma vistosa tradicional.
