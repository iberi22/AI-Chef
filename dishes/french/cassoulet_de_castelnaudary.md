...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Cassoulet de Castelnaudary
  presentation: Cassoulet de Castelnaudary presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Cassoulet de Castelnaudary tradicional
description: >-
  Cassoulet de Castelnaudary es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Cassoulet de Castelnaudary
* **Presentación:** Cassoulet de Castelnaudary presentado de forma vistosa tradicional.
