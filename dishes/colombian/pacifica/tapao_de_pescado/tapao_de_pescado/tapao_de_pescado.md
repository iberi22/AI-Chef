...
sensory:
  ...
  aroma:
    ...
    - Vapor concentrado
  presentation: >-
    Plato hondo con el pescado entero (con cabeza) asomando sobre una base de
    plátanos y yuca. El caldo debe ser claro pero sustancioso. Se sirve con un
    cuarto de limón al lado.
nutrition:
  calories: 380
  macros:
    protein_g: 22
...
description: >-
  El arte de la cocción hermética sin presión mecánica. El 'Tapao' utiliza hojas
  de plátano para crear un sello de vapor que cocina los ingredientes en su
