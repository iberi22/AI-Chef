---
title: Porchetta di Ariccia
region: Lazio (Ariccia)
language: es
license: MIT
source:
...
sensory:
  flavor:
    - Salado especiado potente
    - Romero y romero
    - Pork fat rico
  texture:
    - Corteza (crosta) hiper crujiente sonora
    - Carne interior super suave
  aroma:
    - Piel tostada crujiente
    - 'Romero, pimienta y ajo en espiral'
  presentation: >-
    Rodajas gruesas servidas en pan rústico mostrando la espiral de carne
    sazonada y la corteza dorada.
nutrition:
  calories: 780
  macros:
    protein_g: 42
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Porchetta di Ariccia tradicional
description: >-
...
* **Sabor:** Salado especiado potente, Romero y romero, Pork fat rico
* **Textura:** Corteza (crosta) hiper crujiente sonora, Carne interior super suave
* **Aroma:** Piel tostada crujiente, Romero, pimienta y ajo en espiral
* **Presentación:** Rodajas gruesas servidas en pan rústico mostrando la espiral de carne sazonada y la corteza dorada.
