...
sensory:
  flavor:
    - Tomate guisado acido dulce
    - Vino tinto especiado
    - Hierbas silvestres (romero)
  texture:
    - Carne de pollo tierna jugosa
  aroma:
    - Romero y tomillo frescos
    - Aceitunas negras t interior
  presentation: >-
    Trozos de pollo estofados en salsa roja espesa con aceitunas y hierbas
    leñosas.
nutrition:
  calories: 560
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Pollo alla Cacciatora tradicional
description: >-
...
* **Sabor:** Tomate guisado acido dulce, Vino tinto especiado, Hierbas silvestres (romero)
* **Textura:** Carne de pollo tierna jugosa
* **Aroma:** Romero y tomillo frescos, Aceitunas negras t interior
* **Presentación:** Trozos de pollo estofados en salsa roja espesa con aceitunas y hierbas leñosas.
