...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Pimientos del Padrón
  presentation: Pimientos del Padrón presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Pimientos del Padrón tradicional
description: >-
  Pimientos del Padrón es uno de los platos más emblemáticos de la gastronomía
...
* **Aroma:** Aroma característico de Pimientos del Padrón
* **Presentación:** Pimientos del Padrón presentado de forma vistosa tradicional.
