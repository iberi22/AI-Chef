...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Pulpo a la Gallega (Polbo á Feira)
  presentation: Pulpo a la Gallega (Polbo á Feira) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Pulpo a la Gallega (Polbo á Feira) tradicional
description: >-
  Pulpo a la Gallega (Polbo á Feira) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Pulpo a la Gallega (Polbo á Feira)
* **Presentación:** Pulpo a la Gallega (Polbo á Feira) presentado de forma vistosa tradicional.
