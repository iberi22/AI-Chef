---
title: Som Tum (Ensalada de Papaya)
region: Isan
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Som Tum (Ensalada de Papaya)
  presentation: Som Tum (Ensalada de Papaya) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Som Tum (Ensalada de Papaya) tradicional
description: >-
  Som Tum (Ensalada de Papaya) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Som Tum (Ensalada de Papaya)
* **Presentación:** Som Tum (Ensalada de Papaya) presentado de forma vistosa tradicional.
