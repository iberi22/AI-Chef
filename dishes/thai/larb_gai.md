---
title: Larb Gai (Ensalada de Pollo)
region: Isan
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Larb Gai (Ensalada de Pollo)
  presentation: Larb Gai (Ensalada de Pollo) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Larb Gai (Ensalada de Pollo) tradicional
description: >-
  Larb Gai (Ensalada de Pollo) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Larb Gai (Ensalada de Pollo)
* **Presentación:** Larb Gai (Ensalada de Pollo) presentado de forma vistosa tradicional.
