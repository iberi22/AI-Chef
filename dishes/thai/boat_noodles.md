---
title: Kuay Teow Reua (Boat Noodles)
region: Bangkok
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Kuay Teow Reua (Boat Noodles)
  presentation: Kuay Teow Reua (Boat Noodles) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Kuay Teow Reua (Boat Noodles) tradicional
description: >-
  Kuay Teow Reua (Boat Noodles) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Kuay Teow Reua (Boat Noodles)
* **Presentación:** Kuay Teow Reua (Boat Noodles) presentado de forma vistosa tradicional.
