---
title: Pad Krapow Moo (Cerdo con Albahaca)
region: Bangkok
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Pad Krapow Moo (Cerdo con Albahaca)
  presentation: Pad Krapow Moo (Cerdo con Albahaca) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Pad Krapow Moo (Cerdo con Albahaca) tradicional
description: >-
  Pad Krapow Moo (Cerdo con Albahaca) es uno de los platos más emblemáticos de
...
* **Aroma:** Aroma característico de Pad Krapow Moo (Cerdo con Albahaca)
* **Presentación:** Pad Krapow Moo (Cerdo con Albahaca) presentado de forma vistosa tradicional.
