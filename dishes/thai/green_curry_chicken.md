---
title: Gaeng Keow Wan (Curry Verde)
region: Bangkok
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Gaeng Keow Wan (Curry Verde)
  presentation: Gaeng Keow Wan (Curry Verde) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Gaeng Keow Wan (Curry Verde) tradicional
description: >-
  Gaeng Keow Wan (Curry Verde) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Gaeng Keow Wan (Curry Verde)
* **Presentación:** Gaeng Keow Wan (Curry Verde) presentado de forma vistosa tradicional.
