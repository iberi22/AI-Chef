...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Yam Nua (Ensalada de Res Picante)
  presentation: Yam Nua (Ensalada de Res Picante) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Yam Nua (Ensalada de Res Picante) tradicional
description: >-
  Yam Nua (Ensalada de Res Picante) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Yam Nua (Ensalada de Res Picante)
* **Presentación:** Yam Nua (Ensalada de Res Picante) presentado de forma vistosa tradicional.
