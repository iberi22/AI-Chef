...
sensory:
  flavor:
    - Ácido de naranja agria
    - Achiote terroso
    - Umami
  texture:
    - Carne deshilachada sumamente tierna
  aroma:
    - Naranja agria
    - Achiote
    - Hoja de plátano horneada
  presentation: >-
    Carne de cerdo desmenuzada servida con cebolla morada encurtida en habanero
    y tortillas.
nutrition:
  calories: 680
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Cochinita Pibil tradicional
description: >-
  La Cochinita Pibil es un orgullo yucateco de origen maya, donde el cerdo se
...
* **Sabor:** Ácido de naranja agria, Achiote terroso, Umami
* **Textura:** Carne deshilachada sumamente tierna
* **Aroma:** Naranja agria, Achiote, Hoja de plátano horneada
* **Presentación:** Carne de cerdo desmenuzada servida con cebolla morada encurtida en habanero y tortillas.
