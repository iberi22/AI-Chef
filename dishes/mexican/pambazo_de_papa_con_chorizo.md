...
sensory:
  flavor:
    - Picante de chile guajillo
    - Chorizo sabroso
    - Salado
  texture:
    - Pan suave adobado y dorado al comal
  aroma:
    - Chile guajillo frito
    - Chorizo salteado
  presentation: >-
    Pan telera empapado en adobo rojo de guajillo, dorado en comal y relleno de
    papa con chorizo, lechuga y crema.
nutrition:
  calories: 610
  macros:
    protein_g: 22
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Pambazo de Papa con Chorizo tradicional
description: >-
  El Pambazo es un emparedado popular capitalino cuyo pan se sumerge por
...
* **Sabor:** Picante de chile guajillo, Chorizo sabroso, Salado
* **Textura:** Pan suave adobado y dorado al comal
* **Aroma:** Chile guajillo frito, Chorizo salteado
* **Presentación:** Pan telera empapado en adobo rojo de guajillo, dorado en comal y relleno de papa con chorizo, lechuga y crema.
