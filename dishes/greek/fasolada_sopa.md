---
title: Fasolada (Sopa de Alubias Blancas)
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Fasolada (Sopa de Alubias Blancas)
  presentation: Fasolada (Sopa de Alubias Blancas) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Fasolada (Sopa de Alubias Blancas) tradicional
description: >-
  Fasolada (Sopa de Alubias Blancas) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Fasolada (Sopa de Alubias Blancas)
* **Presentación:** Fasolada (Sopa de Alubias Blancas) presentado de forma vistosa tradicional.
