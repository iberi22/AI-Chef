---
title: Rfissa de Pollo con Lentejas
region: Casablanca
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Rfissa de Pollo con Lentejas
  presentation: Rfissa de Pollo con Lentejas presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Rfissa de Pollo con Lentejas tradicional
description: >-
  Rfissa de Pollo con Lentejas es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Rfissa de Pollo con Lentejas
* **Presentación:** Rfissa de Pollo con Lentejas presentado de forma vistosa tradicional.
