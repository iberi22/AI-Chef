---
title: Baghrir (Panqueques de Mil Hoyos)
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Baghrir (Panqueques de Mil Hoyos)
  presentation: Baghrir (Panqueques de Mil Hoyos) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Baghrir (Panqueques de Mil Hoyos) tradicional
description: >-
  Baghrir (Panqueques de Mil Hoyos) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Baghrir (Panqueques de Mil Hoyos)
* **Presentación:** Baghrir (Panqueques de Mil Hoyos) presentado de forma vistosa tradicional.
