---
title: Pastilla (Bastilla) de Pollo y Almendras
region: Fez
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Pastilla (Bastilla) de Pollo y Almendras
  presentation: >-
    Pastilla (Bastilla) de Pollo y Almendras presentado de forma vistosa
    tradicional.
nutrition:
  calories: 550
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Pastilla (Bastilla) de Pollo y Almendras tradicional
description: >-
  Pastilla (Bastilla) de Pollo y Almendras es uno de los platos más emblemáticos
...
* **Aroma:** Aroma característico de Pastilla (Bastilla) de Pollo y Almendras
* **Presentación:** Pastilla (Bastilla) de Pollo y Almendras presentado de forma vistosa tradicional.
