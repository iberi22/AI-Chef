...
sensory:
  flavor:
    - Azafrán refinado terroso
    - Umami de Parmigiano
    - Mantequilla rica
  texture:
    - Textura mantecada al onda (fluida y cremosa)
  aroma:
    - Azafrán en hebras
    - Tuétano de res (midollo)
    - Vino blanco seco
  presentation: >-
    Plato llano con risotto de color amarillo oro intenso y brillo de
    mantecatura.
nutrition:
  calories: 540
  macros:
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Risotto alla Milanese tradicional
description: >-
...
* **Sabor:** Azafrán refinado terroso, Umami de Parmigiano, Mantequilla rica
* **Textura:** Textura mantecada al onda (fluida y cremosa)
* **Aroma:** Azafrán en hebras, Tuétano de res (midollo), Vino blanco seco
* **Presentación:** Plato llano con risotto de color amarillo oro intenso y brillo de mantecatura.
