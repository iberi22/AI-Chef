...
sensory:
  flavor:
    - Umami cárnico complejo
    - Dulzor sutil de sofrito
    - Salado rico
  texture:
    - Pasta al huevo fresca porosa al dente
  aroma:
    - Ragù cocido a fuego lento
    - Pasta fresca recién estirada
  presentation: Pasta cinta ancha impregnada uniformemente con ragù espeso de res y cerdo.
nutrition:
  calories: 690
  macros:
    protein_g: 32
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Tagliatelle al Ragù Bolognese tradicional
description: >-
...
* **Sabor:** Umami cárnico complejo, Dulzor sutil de sofrito, Salado rico
* **Textura:** Pasta al huevo fresca porosa al dente
* **Aroma:** Ragù cocido a fuego lento, Pasta fresca recién estirada
* **Presentación:** Pasta cinta ancha impregnada uniformemente con ragù espeso de res y cerdo.
