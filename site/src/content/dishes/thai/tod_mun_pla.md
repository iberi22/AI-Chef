...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Tod Mun Pla (Pasteles de Pescado)
  presentation: Tod Mun Pla (Pasteles de Pescado) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Tod Mun Pla (Pasteles de Pescado) tradicional
description: >-
  Tod Mun Pla (Pasteles de Pescado) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Tod Mun Pla (Pasteles de Pescado)
* **Presentación:** Tod Mun Pla (Pasteles de Pescado) presentado de forma vistosa tradicional.
