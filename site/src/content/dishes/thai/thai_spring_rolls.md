---
title: Por Pia Tod (Rollitos Tailandeses)
region: Bangkok
language: es
license: MIT
source:
...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Por Pia Tod (Rollitos Tailandeses)
  presentation: Por Pia Tod (Rollitos Tailandeses) presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Por Pia Tod (Rollitos Tailandeses) tradicional
description: >-
  Por Pia Tod (Rollitos Tailandeses) es uno de los platos más emblemáticos de la
...
* **Aroma:** Aroma característico de Por Pia Tod (Rollitos Tailandeses)
* **Presentación:** Por Pia Tod (Rollitos Tailandeses) presentado de forma vistosa tradicional.
