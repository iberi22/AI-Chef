...
sensory:
  ...
  texture:
    ...
    - Interior tierno
  aroma:
    - Aroma característico de Panang Curry
  presentation: Panang Curry presentado de forma vistosa tradicional.
nutrition:
  calories: 550
  macros:
    protein_g: 28
...
images:
  - url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600'
    description: Panang Curry tradicional
description: >-
  Panang Curry es uno de los platos más emblemáticos de la gastronomía de
...
* **Aroma:** Aroma característico de Panang Curry
* **Presentación:** Panang Curry presentado de forma vistosa tradicional.
